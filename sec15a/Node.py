...
from sec15a.Packet import Packet, UDPPacket, TCPPacket, ARPPacket, DNSPacket, DHCPPacket
from sec15a.Application import ApplicationManager
    ...
    def register_application(self, port, protocol, application_instance):
        ...
        if hasattr(application_instance, "__class__"):
            ...
            if class_name == "FTPServer":
                ...
                if self.application_layer and hasattr(self.application_layer, 'register_https_server'):
                    self.application_layer.register_https_server(application_instance)

            elif class_name == "HTTPSClient":
                if self.application_layer and hasattr(self.application_layer, 'register_https_client'):
