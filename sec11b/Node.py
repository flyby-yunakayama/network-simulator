...
class Node:
    ...
    def count_duplicated_ACK(self, packet):
        ...
        print(f"Node {self.node_id} Last ACK number: {last_ack_number}, Current ACK number: {current_ack_number}, self.tcp_connections[connection_key]["duplicate_ack_count"]")
