...
from sec11a.Packet import Packet, UDPPacket, TCPPacket, ARPPacket, DNSPacket, DHCPPacket
    ...
    def process_TCP_packet(self, packet):
        if packet.header["destination_mac"] == self.mac_address:
            if packet.header["destination_ip"] == self.ip_address:
                ...
                print(self.node_id, flags, packet.header["sequence_number"], packet.header["acknowledgment_number"])
